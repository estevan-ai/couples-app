...
exports.processJournalCoolDown = void 0;
...
async function getRawThreadContent(threadId, partnerId) {
...
exports.processJournalCoolDown = functions.pubsub.schedule('every 30 minutes').onRun(async (context) => {
    ...
    for (const sessionDoc of activeSessions.docs) {
        ...
        try {
            ...
            const prompt = `${prompts_1.CLIFF_NOTE_SUMMARIZER_PROMPT}\n\nThe raw venting session is below:\n${rawThreadText}`;
...
//# sourceMappingURL=journalCron.js.map